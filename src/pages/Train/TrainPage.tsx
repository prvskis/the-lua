    ...
    >
      <div className={['flex', reverse ? 'justify-start' : 'justify-end'].join(' ')}>
        <ImageFrame
          ...
          alt={imageAlt}
          ratio="aspect-[1/1.08]"
          className="group w-full max-w-[440px] rounded-tr-[140px] bg-black/5 transition-shadow duration-300 hover:shadow-[0_20px_40px_rgba(34,36,88,0.12)]"
        ...
        >
          {description.map((paragraph, index) => (
            <TextLineReveal
              ...
              as="p"
              text={paragraph}
              className="font-inter text-[16px] leading-8 tracking-[0.03em]"
              style={{ color: `${NAVY}CC` }}
              delay={index * 0.12}
              lineDelay={0.08}
            />
  ...
  return (
    <Section className="pt-0">
      <div className="mx-auto max-w-[1180px] rounded-tr-[110px] bg-[#F2E6D3] px-7 py-9 sm:px-10 lg:px-12 lg:py-10">
        <h2 className="font-regal text-[44px] leading-none tracking-[0.01em] md:text-[64px]" style={{ color: NAVY }}>
          STAY ON TRACK
        </h2>
        ...
        <div id="immersive-vietnam">
          ...
          <div className="mt-6 grid gap-8 lg:grid-cols-[minmax(0,530px)_minmax(0,1fr)] lg:items-center lg:gap-10">
            <RevealOnScroll delay={0.08}>
              ...
              <div
                className="mt-6 max-w-[620px] space-y-5 font-inter text-[16px] leading-9 tracking-[0.04em]"
                style={{ color: NAVY }}
              >
                <TextLineReveal
                  as="p"
